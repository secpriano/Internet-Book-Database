...
public class ThemeContainer
{
    ...
    private void ValidateDescription(string description)
    {
        ...
        Validate.Regex(description, @"^[a-zA-Z ,&+-]+$", "Description", "Description can only contain letters, spaces, commas, plus, minus, and ampersands.");
        if (_themeData.Exist(description)) throw new KeyValueException($"Theme {description} is already in use.", "Description");
    }
}